  ...
  return (
    <div className="h-full p-5 shrink-0 w-[300px] bg-red-300 rounded-2xl shadow-lg">
      <div className="flex justify-between items-center">
        <h3 className="bg-green-600 px-3 py-1 rounded-3xl text-white text-sm font-medium">
          {data?.category}
        </h3>
      ...
      <div className="mt-6">
        <button className="w-full px-4 py-2 text-white bg-green-500 hover:bg-green-600 transition rounded-lg shadow-md">
          Completed
        </button>
      </div>
    </div>
